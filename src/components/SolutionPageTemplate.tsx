        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the advanced capabilities that make {solution.name} the industry leader
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Detailed specifications and performance metrics for {solution.name}
            </p>
          </motion.div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Watch our videos to see the solution in operation
              </p>
            </motion.div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Hear what our customers say about {solution.name}
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact our experts to learn more about how {solution.name} can benefit your operation
            </p>
